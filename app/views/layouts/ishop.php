				...
				<div class="container">
					<div class="row justify-content-between">
						...
						<div class="col text-end icons">
										...
										<div class="modal-body">
											<table class="table text-start">
												...
												<tbody>
													<tr>
														<td>
															<a href="#"><img src="<?= PATH?>/static/img/products/apple_cinema_30.jpg" alt=""></a>
														</td>
													...
													<tr>
														<td>
															<a href="#"><img src="<?= PATH?>/static/img/products/canon_eos_5d_1.jpg" alt=""></a>
														</td>
													...
													<tr>
														<td>
															<a href="#"><img src="<?= PATH?>/static/img/products/hp_1.jpg" alt=""></a>
														</td>
														<td><a href="#">HP</a></td>
														<td>1</td>
														<td>100</td>
							...
							<div class="dropdown d-inline-block">
								<a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
									<img src="<?= PATH?>/static/img/ru.png" alt="">
								</a>
								<ul class="dropdown-menu" id="languages">
									<li>
										<button class="dropdown-item" data-langcode="en">
											<img src="<?= PATH?>/static/img/en.png" alt="">
										English</button>
									</li>
								</ul>
							</div>
			...
			<div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="<?= PATH?>/static/img/1.jpg" class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="<?= PATH?>/static/img/2.jpg" class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="<?= PATH?>/static/img/3.jpg" class="d-block w-100" alt="...">
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?= PATH?>/static/img/products/iphone_1.jpg" alt=""></a>
							</div>
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?= PATH?>/static/img/products/canon_eos_5d_1.jpg" alt=""></a>
							</div>
							<div class="product-details">
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?= PATH?>/static/img/products/hp_1.jpg" alt=""></a>
							</div>
							<div class="product-details">
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?= PATH?>/static/img/products/apple_cinema_30.jpg" alt=""></a>
							</div>
							<div class="product-details">
					...
					<div class="col-lg-4 col-sm-6 mb-3">
						<div class="product-card">
							<div class="product-tumb">
								<a href="product.html"><img src="<?= PATH?>/static/img/products/imac_1.jpg" alt=""></a>
							</div>
							<div class="product-details">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 col-6">
							<h4>Время работы</h4>
							<ul class="list-unstyled">
								<li>г. Екатеринбург, ул. Пушкина, 10</li>
